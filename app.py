...
from resources.follow import FollowMemoResource, FollowQuitResource, FollowResource
...
api.add_resource(FollowResource, "/follow/add")
api.add_resource(FollowQuitResource, "/follow/<int:user_id>")
